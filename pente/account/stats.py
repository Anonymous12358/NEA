...
########################################################################################################################
# SECTION A SKILL: CROSS-TABLE PARAMETERISED SQL                                                                       #
...
# The Wins table refers to users by their UUID rather than name, so queries are cross-table to provide access to       #
